package com.rusty.membership.adapter.out.persistence;

import com.rusty.common.events.PersistenceAdapter;
...
import com.rusty.membership.application.port.out.UpdateMembershipPort;
